...
export const PROJECTS = [
  {
    ...
    description: {
      EN: 'Android application to collect the stamps of the Qatar 2022 World Cup with more than 1,000 downloads.',
      ES: 'Aplicación de android para coleccionar las estampas del mundial Qatar 2022 con más de 1,000 descargas.',
    },
